...
wget https://github.com/brokercap/Bifrost/releases/download/v2.0.1-beta/bifrost_v2.0.2-beta_Linux-amd64-bin.tar.gz

tar -zxvf bifrost_v2.0.2-beta_Linux-amd64-bin.tar.gz

cd bifrost_v2.0.2-beta_Linux-amd64-bin/bin && chmod a+x ./Bifrost*
