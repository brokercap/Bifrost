...
wget https://github.com/brokercap/Bifrost/releases/download/v1.8.1-release/bifrost_v1.8.1-release_Linux-amd64-bin.tar.gz

tar -zxvf bifrost_v1.8.1-release_Linux-amd64-bin.tar.gz

cd bifrost_v1.8.1-release_Linux-amd64-bin/bin && chmod a+x ./Bifrost*
