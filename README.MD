...
wget https://github.com/jc3wish/Bifrost/releases/download/v1.0.1-release/Bifrost_v1.0.1-release_bin_linux.zip

unzip Bifrost_v1.0.1-release_bin_linux.zip

cd Bifrost_v1.0.1-release_bin_linux
