...
```
wget https://github.com/brokercap/Bifrost/releases/download/v1.6.4-release/bifrost_v1.6.4-release_Linux-amd64-bin.tar.gz

tar -zxvf bifrost_v1.6.4-release_Linux-amd64-bin.tar.gz

cd bifrost_v1.6.4-release_Linux-amd64-bin/bin && chmod a+x ./Bifrost*
